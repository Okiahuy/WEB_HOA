...
const ProductHomeUserComponentKieng = () => {
...
useEffect(() => {
  const fetchProducts = async () => {
    try {
      const response = await productService.getProductsForUserKieng(6, 12);
...
useEffect(() => {
  ...
  export default ProductHomeUserComponentKieng; // Export mặc định